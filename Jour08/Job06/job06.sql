...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : mar. 06 juin 2023 à 10:19
...
INSERT INTO `etudiants` (`id`, `prenom`, `nom`, `naissance`, `sexe`, `email`, `prenom`) VALUES
(5, 'Terry', 'Cristinelli', '2005-02-01', 'Homme', 'terry@laplateforme.io', 'Terry'),
(7, 'Toto', 'Dupont', '2019-11-07', 'Homme', 'toto@laplateforme.io', 'Toto');
COMMIT;
