...
<body>
    ...
    <ul>
        <li>l'ensemble des informations des salles,</li>
...
<?php
echo "<h3><hr>Requête qui selectionne l'ensemble des informations des salles en les triant par capacité croissance</h3>";
